...
Set.prototype.diffrence = function <T>(set: Set<T>) {
  // const result = new Set<T>(this);
...
const set = new Set<number>(new Set([1, 2, 3, 4, 5]));

console.log(set.union(new Set<number>([2, 3, 4, 5])));
console.log(set);

console.log(set.diffrence(new Set<number>([3])));

Set.prototype.isSuperset = function <T>(subset: Set<T>) {
